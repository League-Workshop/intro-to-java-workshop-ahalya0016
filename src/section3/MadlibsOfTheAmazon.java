...
JOptionPane.showMessageDialog(null,"Prianhas are more " + adj + " during the day, so cross the river at night. Piranhas are attracted to fresh " + Liquid + " and will most likely take a bite out of your " + part + " if you " + verb + ". Whatever you do, if you have an open wound, try to find another way back to the " + Place);
	}
}
